import { onValue, get, ref, update } from "firebase/database";
...
async function handleBookingsUpdate(snapshot) {
    ...
    const newBookingIds = new Set(Object.keys(data || {}));
    const incomingBookingIds = Object.keys(data || {});

    if (data && incomingBookingIds.length > 0) {
